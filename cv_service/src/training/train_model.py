"""
Training script for supervised handwriting classification (EfficientNet only)
"""
import os
import torch
...
def train_efficientnet_model(train_loader, val_loader, device):
    """Train EfficientNet model and return the trained model and best val accuracy"""
...
# Removed robustness/ensemble utilities for simplicity


# Removed ensemble weighting utilities


# Removed ensemble evaluation


def train_supervised_model():
    """Train the EfficientNet classification model"""

    print("=== BETFRED HANDWRITING TRAINING (EfficientNet) STARTED ===")
    print("=" * 60)
    ...
    return model, accuracy, val_loader, device


if __name__ == "__main__":
    print("\n🔹 BetFred Handwriting Classification System 🔹")
    print("🔹 EfficientNet Training Tool              🔹")
    ...
    print("✓ Classification API will automatically use the new EfficientNet model")
